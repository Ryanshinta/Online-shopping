...
public class orderController {
    ...
    public void addToCart() {
        ...
        item Item0001 = new item(0001, "TestProduct1", "This is a test Product1", BigDecimal.valueOf(99.99));
        item Item0002 = new item(0002, "TestProduct2", "This is a test Product2", BigDecimal.valueOf(99.92));

        item Item003 = new item(0003, "TestProduct3", "This is a test Product3", BigDecimal.valueOf(42.22));
